...
class Course {
  ...
  late final int? theNumberOfSeasons, theNumberOfsessions;
  ...
  Course.fromJson(Map<String, dynamic> json) {
    ...
    theNumberOfsessions = json['the_number_of_sessions'];
    ...
    seasons =
        (json['seasons'] != null) ? Seasons.fromJson(json['seasons']) : null;
  }
}
